...
<section id="banner" class="major">
	<div class="inner">
		...
		<div class="content">
			...
			<ul class="actions">
				<li><a href="#one" class="button next scrolly">Come?</a></li>
			</ul>
		</div>
	</div>
</section>
...
<section id="two">
	<div class="inner">
		...
		<ul class="actions">
			<li><a href="contatti.html" class="button big next">Contattami</a></li>
			<li><a href="chi-sono.html" class="button big special icon fa-hand-peace-o">su di me</a></li>
		</ul>
	</div>
</section>
