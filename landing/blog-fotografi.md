---
layout: landing
title: Blog con il giusto layout per un fotografo
description: Le giuste propriet&agrave; che un prodotto di pubblicazione per fotografi deve avere
...
<section id="banner" class="style2">
	<div class="inner">
		...
		<header class="major">
			<h1>Lo spazio giusto per organizzare e catalogare le tue foto</h1>
		</header>
		<div class="content">
